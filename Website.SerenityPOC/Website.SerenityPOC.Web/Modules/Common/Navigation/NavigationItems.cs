...
using Northwind = Website.SerenityPOC.Northwind.Pages;
using Administration = Website.SerenityPOC.Administration.Pages;
using Basic = Website.SerenityPOC.BasicSamples.Pages;
